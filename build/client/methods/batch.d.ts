...
export type CommandsPayloads<C extends Commands, CM = {
...
export type Batch = <C extends Commands, P = CommandsPayloads<C>>(commands: C, commandsPerRequest?: number) => Promise<BatchPayload<P>>;
type Dependencies = {
